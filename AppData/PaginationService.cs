...
namespace BookMaster.AppData
{
    public class PaginationService
    {
        ...
        public void UpdatePaginationButtons(Button previousBth, Button nextBth)
        {
            previousBth.IsEnabled = _currentPageIndex > 0;
            nextBth.IsEnabled = _currentPageIndex < TotalPages - 1;
